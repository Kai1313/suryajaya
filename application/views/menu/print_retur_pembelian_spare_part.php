      ...
      <main>
        <div class="row">
          <div class="col-sm-4 col-xs-4 to-details">
            <div>Data :</div>
            <div class="to-name" name="no_nota"></div>
            <div class="to-phone" name="nota_toko"></div>
            <div class="to-address" name="tgl_nota"></div>
          </div>
            ...
            <table class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  ...
                  <th class="text-center col-xs-4 col-sm-4">Nama</th>
  ...
  <script>
    ...
    {
      $.ajax({
        url : "<?php echo site_url('Crud/getPrintReturBeliBarang/')?>"+key,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
          $('[name="no_nota"]').text('Nota '+data['a'].no_nota);
          $('[name="nota_toko"]').text('Nota Toko '+data['a'].nota_toko);
          $('[name="tgl_nota"]').text('Tgl. Nota '+data['a'].tgl_nota);
          $('[name="data_code"]').text(data['a'].no_retur);
          $('[name="data_date"]').text(data['a'].tgl_retur);
