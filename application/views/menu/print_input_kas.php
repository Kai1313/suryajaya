      ...
      <main>
        <div class="row">
          <div class="col-sm-4 col-xs-4 to-details">
            ...
            <h3>Debet <span name="debet" class="chgnum"></span></h3>
            <h3>Kredit <span name="kredit" class="chgnum"></span></h3>
          </div>
  ...
  <script>
    ...
    {
      $.ajax({
        url : "<?php echo site_url('Crud/getPrintKas/')?>"+key,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
          $('[name="keterangan"]').text('Keterangan '+data['a'].ket_kas);
          $('[name="debet"]').text(data['a'].debet);
          $('[name="kredit"]').text(data['a'].kredit);
          $('[name="data_code"]').text(data['a'].no_kas);
          $('[name="data_date"]').text(data['a'].tgl_kas);
