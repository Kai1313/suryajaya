            ...
            <table id="rptUpah" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  ...
                  <th class="text-center col-xs-3 col-sm-3">No Kuitansi</th>
                  <th class="text-center col-xs-3 col-sm-3">Karyawan</th>
                  <th class="text-center col-xs-2 col-sm-2">Potong Bon</th>
  ...
  <script>
    ...
    function fetchData()
    {
      table = $('#rptUpah').DataTable({
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/rptBayarUpahKaryawan')?>",
          "type": "POST",
          "data": function(data)
            {
