      ...
      <main>
        ...
        <div class="row">
          <div class="col-sm-12 col-xs-12 table-responsive">
            <table id="rptLepasBan" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  <th class="text-center col-xs-1 col-sm-1">Tanggal</th>
                  <th class="text-center col-xs-1 col-sm-1">No Lepas</th>
  ...
  <script>
    ...
    function fetchData()
    {
      table = $('#rptLepasBan').DataTable({
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/rptLepasBan')?>",
          "type": "POST",
          "data": function(data)
            {
