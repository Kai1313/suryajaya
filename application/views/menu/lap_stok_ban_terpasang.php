      ...
      <header>
        <div class="row">
          <div class="col-xs-12 text-center">
            <h2>LAPORAN STOK BAN TERPASANG</h2>
          </div>
        </div>
        <div class="row">
      ...
      <main>
        ...
        <div class="row">
          <div class="col-sm-12 col-xs-12 table-responsive">
            <table id="rptStokBanTerpasang" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  <th class="text-center col-xs-2 col-sm-2">Ket. Ban</th>
                  <th class="text-center col-xs-2 col-sm-2">Supplier</th>
                  <th class="text-center col-xs-1 col-sm-1">Ukuran</th>
                  <th class="text-center col-xs-1 col-sm-1">Jenis</th>
                  <th class="text-center col-xs-1 col-sm-1">No BKL</th>
                  <th class="text-center col-xs-1 col-sm-1">Bengkel</th>
                  <th class="text-center col-xs-1 col-sm-1">Tgl Pakai</th>
                  <th class="text-center col-xs-1 col-sm-1">Kondisi</th>
  ...
  <script>
    ...
    function fetchData()
    {
      table = $('#rptStokBanTerpasang').DataTable({
        "info": false,
        "responsive": true,
        "processing": true,
        "serverSide": true,
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/rptStokBanTerpasang')?>",
          "type": "POST",
          "data": function(data)
            {
