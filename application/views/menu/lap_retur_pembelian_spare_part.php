      ...
      <main>
        ...
        <div class="row">
          <div class="col-sm-12 col-xs-12 table-responsive">
            <table id="rptReturBeliBarang" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  ...
                  <th class="text-center col-xs-2 col-sm-2">Nota Toko</th>
  ...
  <script>
    ...
    function fetchData()
    {
      table = $('#rptReturBeliBarang').DataTable({
        "info": false,
        "responsive": true,
        "processing": true,
        "serverSide": true,
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/rptReturBeliBarang')?>",
          "type": "POST",
          "data": function(data)
            {
              data.no_nota = $('[name="no_nota"]').val();
