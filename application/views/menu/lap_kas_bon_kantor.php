      ...
      <main>
        ...
        <div class="row">
          <div class="col-sm-12 col-xs-12 table-responsive">
            <table id="rptBon" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  ...
                  <th class="text-center col-xs-2 col-sm-2">Sopir-Kernet</th>
                  <th class="text-center col-xs-2 col-sm-2">Bon Sangu-Solar</th>
                  <th class="text-center col-xs-2 col-sm-2">Berangkat</th>
                  <th class="text-center col-xs-2 col-sm-2">Kembali</th>
                </tr>
              </thead>
