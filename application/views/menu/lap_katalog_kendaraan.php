      ...
      <main>
        ...
        <div class="row">
          <div class="col-sm-12 col-xs-12 table-responsive">
            <table id="rptKatalog" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
  ...
  <script>
    ...
    function fetchData()
    {
      table = $('#rptKatalog').DataTable({
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/rptKatalog')?>",
          "type": "POST",
          "data": function(data)
            {
