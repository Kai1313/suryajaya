    ...
    function pilihKasBon(id)
    {
      $.ajax({
        ...
        success: function(data)
        {
          ...
          $('[name="tgl_berangkat"]').val(moment(data.tgl_berangkat).format('DD/MM/YYYY'));
          $('[name="tgl_datang"]').val(moment(data.tgl_datang).format('DD/MM/YYYY'));
          $('[name="jumlah_pp"]').val(data.jumlah_pp);
          ...
          $('#dropBiayaSbyJkt').val(data.kode_biaya_sbyjkt).trigger('change');
          $('#dropBiayaJktSby').val(data.kode_biaya_jktsby).trigger('change');
          $('#dropBiayaPulang').val(data.pulang).trigger('change');
          $('#dropSanguJkt').val(data.bon_sangujkt).trigger('change');
          pickJenisKendaraan(data.jenis_kendaraan);
          ...
          $('[name="solar_jkt"]').val(data.solar_jkt);
          $('[name="solar_sby"]').val(data.solar_sby);
          $('[name="solar_naik"]').val(data.solar_naik);
          $('[name="bantuan1"]').val(data.bantuan_a);
          $('[name="bantuan2"]').val(data.bantuan_b);
          $('[name="bantuan3"]').val(data.bantuan_c);
          $('[name="bantuan4"]').val(data.bantuan_d);
          $('[name="inp_koreksi1"]').val(data.tambah_a);
          $('[name="inp_koreksi2"]').val(data.tambah_b);
          $('[name="inp_koreksi3"]').val(data.tambah_c);
          $('[name="ngepok"]').val(data.ngepok);
          $('[name="retribusi"]').val(data.retribusi);
          $('[name="inp_hutangpribadi"]').val(data.hutang_pribadi);
          $('[name="inp_klaim"]').val(data.klaim);
          $('[name="inp_uangkenek"]').val(data.uang_kenek);
          $('[name="inp_tabsopir"]').val(data.tab_sopir);
          $('#newBtn').prop('disabled',true);
