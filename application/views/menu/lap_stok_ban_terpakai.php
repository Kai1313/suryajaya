      ...
      <main>
        ...
        <div class="row">
          <div class="col-sm-12 col-xs-12 table-responsive">
            <table id="rptStokBanTerpakai" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  <th class="text-center col-xs-1 col-sm-1">Tgl Pakai</th>
                  <th class="text-center col-xs-1 col-sm-1">Tgl Lepas</th>
  ...
  <script>
    ...
    function fetchData()
    {
      table = $('#rptStokBanTerpakai').DataTable({
        "info": false,
        "responsive": true,
        "processing": true,
        "serverSide": true,
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/rptStokBanTerpakai')?>",
          "type": "POST",
          "data": function(data)
            {
