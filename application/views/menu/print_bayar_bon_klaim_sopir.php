      ...
      <main>
        <div class="row">
          <div class="col-sm-4 col-xs-4 to-details">
            ...
            <h3>Jumlah Klaim<span name="jml_klaim" class="chgnum"></span></h3>
            <h3>Jumlah Bon<span name="jml_bon" class="chgnum"></span></h3>
          </div>
  ...
  <script>
    ...
    {
      $.ajax({
        url : "<?php echo site_url('Crud/getPrintBonKlaimSopir/')?>"+key,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
          $('[name="sopir"]').text('Nama '+data['a'].nama_driver);
          $('[name="jml_klaim"]').text(data['a'].nom_klaim);
          $('[name="jml_bon"]').text(data['a'].nom_bon);
          $('[name="data_code"]').text(data['a'].no_bayar);
          $('[name="data_date"]').text(data['a'].tgl_bayar);
