<!-- Content Wrapper. Contains page content -->
        ...
        <div class="col-md-12 col-xs-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Form Kuitansi</h3>
            </div>
                  ...
                  <div class="col-md-6 col-xs-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="text" name="tgl_kuitansi" class="form-control pull-right" id="tgl_kuitansi" placeholder="dd/mm/yyyy">
                      </div>
                    </div>
                    <div class="form-group">
                      <label>Kode Rekening</label>
                      <select class="form-control" name="kode_rekening" id="dropRekening" style="width: 100%;">
                        <option value="">Pilih Rekening</option>
                      </select>
                    </div>
                    <div class="form-group">
                      <br>
                      <button type="button" id="newBtn" class="btn btn-sm btn-primary" onclick="newKuitansi()">Kuitansi Baru</button>
                      <button type="button" id="editBtn" class="btn btn-sm btn-primary" onclick="editKuitansi()">Edit Biaya</button>
                    </div>
                  </div>
                  <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="ket_kuitansi" rows="2"></textarea>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-md-12 col-xs-12">
          <div class="box">
            <div class="box-body">
              ...
              <div id="alertMsg"></div>
              <table id="m_kuitansi" class="table table-bordered table-striped" cellpadding="0" cellspacing="0" width="100%">
                <thead>
                  <tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <table id="daftarKuitansi" class="table table-bordered table-striped" cellpadding="0" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th>No</th>
                  <th>No Kuitansi</th>
  ...
  <script>
    ...
    function newKuitansi()
    {
      $.ajax({
        type: 'GET',
        url: '<?= site_url('Crud/gen_noKuitansi')?>',
        dataType: 'JSON',
    ...
    function tbDetKuitansi(key)
    {
      table = $('#m_kuitansi').DataTable({
        "info": false,
        "destroy": true,
        "responsive": true,
        "processing": true,
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/detKuitansi/')?>"+key,
          "type": "POST",
          },
        "columnDefs": [
          { 
    ...
    function editKuitansi()
    {
      $('#modal-edit').modal('show');
      $('.modal-title').text('Daftar Biaya Kuitansi');
      table = $('#daftarKuitansi').DataTable({
        "info": false,
        "destroy": true,
        "responsive": true,
        "processing": true,
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/listKuitansi')?>",
          "type": "POST",
          },
        "columnDefs": [
          { 
    ...
    {
      key = ($('[name="no_kuitansi"]').val()!='')?$('[name="no_kuitansi"]').val():'';
      window.open ( "<?= site_url('Crud/printKuitansi/')?>"+key,'_blank');
    }
    function reportDt()
    {
      window.open ( "<?= site_url('Crud/reportKuitansi')?>",'_blank');
    }
  </script>