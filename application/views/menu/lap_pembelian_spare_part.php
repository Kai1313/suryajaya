      ...
      <main>
        ...
        <div class="row">
          <div class="col-sm-12 col-xs-12 table-responsive">
            <table id="rptBeliBarang" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  <th class="text-center col-xs-1 col-sm-1">Tanggal</th>
                  <th class="text-center col-xs-2 col-sm-2">Supplier</th>
                  <th class="text-center col-xs-3 col-sm-3">Nama Barang</th>
  ...
  <script>
    ...
    function fetchData()
    {
      table = $('#rptBeliBarang').DataTable({
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/rptBeliBarang')?>",
          "type": "POST",
          "data": function(data)
            {
              data.kode_supplier = $('[name="kode_supplier"]').val();
