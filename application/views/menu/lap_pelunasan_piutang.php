      ...
      <main>
        ...
        <div class="row">
          <div class="col-sm-12 col-xs-12 table-responsive">
            <table id="rptLunas" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  <th class="text-center col-xs-2 col-sm-2">Tanggal</th>
                  <th class="text-center col-xs-2 col-sm-2">No Pelunasan</th>
                  <th class="text-center col-xs-2 col-sm-2">Klien</th>
                  <th class="text-center col-xs-2 col-sm-2">No Tagihan</th>
                  <th class="text-center col-xs-2 col-sm-2">No Bon</th>
  ...
  <script>
    ...
    function fetchData()
    {
      table = $('#rptLunas').DataTable({
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/rptPelunasanPiutang')?>",
          "type": "POST",
          "data": function(data)
            {
              data.kode_customer = $('[name="kode_customer"]').val();
