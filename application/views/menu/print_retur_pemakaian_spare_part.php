      ...
      <main>
        <div class="row">
          <div class="col-sm-4 col-xs-4 to-details">
            ...
            <div class="to-phone" name="nopol"></div>
  ...
  <script>
    ...
    {
      $.ajax({
        url : "<?php echo site_url('Crud/getPrintReturPakaiBarang/')?>"+key,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
          $('[name="no_nota"]').text('Nota '+data['a'].no_pakai_brg);
          $('[name="nopol"]').text('Nopol '+data['a'].nopol);
          $('[name="tgl_nota"]').text('Tgl. Nota '+data['a'].tgl_pakai_brg);
