  ...
  <body>
    <div class="container hidden-print">
      <div class="row">
        ...
        <div class="col-sm-2 col-xs-3">
          <label>Sopir</label>
          <select class="form-control" name="kode_driver" id="dropSopir" style="width: 100%;">
      ...
      <main>
        ...
        <div class="row">
          <div class="col-sm-12 col-xs-12 table-responsive">
            <table id="rptUpah" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  <th class="text-center col-xs-2 col-sm-2">Tanggal</th>
                  <th class="text-center col-xs-3 col-sm-3">No Bayar</th>
                  <th class="text-center col-xs-3 col-sm-3">Sopir</th>
                  <th class="text-center col-xs-2 col-sm-2">Bon</th>
                  <th class="text-center col-xs-2 col-sm-2">Klaim</th>
                </tr>
              </thead>
  ...
  <script>
      ...
      $.ajax({
        ...
        {   
          ...
          for (var i = 0; i < data.length; i++)
          {
            ...
            option.text = data[i]['nama_driver'];
            select.add(option);
          }
    ...
    function fetchData()
    {
      table = $('#rptUpah').DataTable({
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/rptBayarSopir')?>",
          "type": "POST",
          "data": function(data)
            {
              data.kode_driver = $('[name="kode_driver"]').val();
