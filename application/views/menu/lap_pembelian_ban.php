      ...
      <main>
        ...
        <div class="row">
          <div class="col-sm-12 col-xs-12 table-responsive">
            <table id="rptBeliBan" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
  ...
  <script>
      ...
      $.ajax({
        ...
        {   
          ...
          for (var i = 0; i < data.length; i++)
          {
            ...
            option.text = data[i]['nama_supplier'];
            select.add(option);
          }
    ...
    function fetchData()
    {
      table = $('#rptBeliBan').DataTable({
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo site_url('Datatables/rptBeliBan')?>",
          "type": "POST",
          "data": function(data)
            {
