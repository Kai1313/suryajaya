<?php
	...
	class ReportOpnameBan extends CI_Model 
	{
		var $table = 'inv_ban a';
		var $column_order = array('b.kode_ban','b.ukuran_ban','b.jenis_ban','a.bkl','a.sts_stok');
		var $column_search = array('b.kode_ban','b.ukuran_ban','b.jenis_ban','a.bkl','a.sts_stok');
