<?php
	...
	class ReportInputBon extends CI_Model 
	{
		var $table = 'trx_input_bon_karyawan a';
		var $column_order = array('tgl_bon','no_bon','nama_karyawan','ket_bon','nom_bon');
		var $column_search = array('tgl_bon','no_bon','nama_karyawan','ket_bon','nom_bon');
