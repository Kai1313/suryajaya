<?php
	...
	class DetPelepasanBan extends CI_Model 
	{
		var $table = 'trx_lepas_ban_det a';
		var $column_order = array(null,'c.jenis_ban','c.ukuran_ban','c.merk_ban','a.status_lepas','a.qty_lepas',null);
		var $column_search = array('c.jenis_ban','c.ukuran_ban','c.merk_ban','a.status_lepas','a.qty_lepas');
