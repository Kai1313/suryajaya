<?php
	...
	class DetReturPembelianBarang extends CI_Model 
	{
		var $table = 'trx_retur_beli_barang_det a';
		var $column_order = array(null,'c.nama_barang','a.qty_retur','a.jumlah');
		var $column_search = array('c.nama_barang','a.qty_retur','a.jumlah');
